...
const SearchPlaces = () => {
  ...
  const handleSaveSearch = async (searchId) => {
    ...
    const restaurantsToSave = restaurants.find(
      (restaurant) => restaurant.restaurantId === searchId
    );
              ...
              if (restaurant && restaurant.restaurantId) {
                return (
                  <Card
                    ...
                    border="border-bottom border-warning"
                    className="cardbody-css"
                  >
                    <Card.Img
                    ...
                    <Card.Body>
                      ...
                      <Card.Subtitle className="cardprice">
                        ...
                        {`Restaurant Price: ${restaurant.priceLevel}`}
                      </Card.Subtitle>
                      <Card.Subtitle className="cardrating">
                      ...
                      {Auth.loggedIn() && (
                        <div className="d-flex">
                          <Button
                            className="btn-info center save-btn-css mt-3"
                            variant="secondary"
                            size="sm"
                            onClick={() =>
                              handleSaveSearch(restaurant.restaurantId)
                            }
                          >
